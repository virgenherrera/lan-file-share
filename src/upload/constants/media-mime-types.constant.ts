...
export const MediaMimeTypeSource: MimeTypeSource = [
  ['.3g2', '3GPP2 audio/video container', 'video/3gpp2'],
  ['.3g2', '3GPP2 audio/video container', 'audio/3gpp2'],
  ['.3gp', '3GPP audio/video container', 'video/3gpp'],
  ['.3gp', '3GPP audio/video container', 'audio/3gpp'],
...
const initialValue = {
  MediaFileExtensions: [] as string[],
  MediaDocumentKinds: [] as string[],
  MediaMimeTypes: [] as string[],
};

export const { MediaFileExtensions, MediaDocumentKinds, MediaMimeTypes } =
  MediaMimeTypeSource.reduce((acc, [ext, kind, mime]) => {
    acc.MediaFileExtensions.push(ext);
    acc.MediaDocumentKinds.push(kind);
    acc.MediaMimeTypes.push(mime);
